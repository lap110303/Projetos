...
int introbatalha = 0;
int batalha = 0;
bool dano_ataque = false;
bool dano_recebido = false;
...
<<<<<<< HEAD
//Testando Pokemons
PokemonEletrico* p = new PokemonEletrico("pikachu", 1, 15.0, 100.0, 1.0, "Ataque Rapido", "Jato de Agua");
PokemonEletrico* r = new PokemonEletrico("raichu", 1, 5.0, 100.0, 1.0, "Ataque Rapido", "ataque do trovao");
=======

//Declarando Pokemons
// Eletricos

PokemonEletrico* pikachu = new PokemonEletrico("Pikachu", 1, 15.0, 100.0, 1.0, "Ataque Rapido", "Choque do Trovao");

PokemonEletrico* raichu = new PokemonEletrico("Raichu", 1, 15.0, 100.0, 1.0, "Ataque Rapido", "Cauda de Ferro");

PokemonEletrico* magnemite = new PokemonEletrico("Magnemite", 1, 15.0, 100.0, 1.0, "Ataque Sonico", "Supersonico");

PokemonEletrico* magneton = new PokemonEletrico("Magneton", 1, 15.0, 100.0, 1.0, "Ataque Sonico", "Raio Magnetico");

PokemonEletrico* voltorb = new PokemonEletrico("Voltorb", 1, 15.0, 100.0, 1.0, "Ataque Rapido", "Auto-Destruicao");

PokemonEletrico* electrode = new PokemonEletrico("Electrode", 1, 15.0, 100.0, 1.0, "Ataque Rapido", "Explosao");

PokemonEletrico* jolteon = new PokemonEletrico("Jolteon", 1, 15.0, 100.0, 1.0, "Ataque Rapido", "Choque do Trovao");

PokemonEletrico* electabuzz = new PokemonEletrico("Electabuzz", 1, 15.0, 100.0, 1.0, "Soco Eletrico", "Raio Psiquico");

// Aquaticos
PokemonAgua* squirtle = new PokemonAgua("Squirtle", 1, 15.0, 100.0, 1.0, "Ataque Rapido", "Jato de agua");

PokemonAgua* wartortle = new PokemonAgua("Wartortle", 1, 15.0, 100.0, 1.0, "Cabecada", "Jato de agua");

PokemonAgua* blastoise = new PokemonAgua("Blastoise", 1, 15.0, 100.0, 1.0, "Investida", "Canhao de agua");

PokemonAgua* psyduck = new PokemonAgua("Psyduck", 1, 15.0, 100.0, 1.0, "Arranhao", "Jato de agua");

PokemonAgua* golduck = new PokemonAgua("Golduck", 1, 15.0, 100.0, 1.0, "Golpe Rapido", "Hidro Bomba");

PokemonAgua* poliwag = new PokemonAgua("Poliwag", 1, 15.0, 100.0, 1.0, "Hipnose", "Jato de agua");

PokemonAgua* poliwhirl = new PokemonAgua("Poliwhirl", 1, 15.0, 100.0, 1.0, "Soco", "Jato de agua");

// Planta
PokemonPlanta* bulbasaur = new PokemonPlanta("Bulbasaur", 1, 15.0, 100.0, 1.0, "Investida", "Folha Navalha");

PokemonPlanta* ivysaur = new PokemonPlanta("Ivysaur", 1, 15.0, 100.0, 1.0, "Investida", "Chicote de Vinha");

PokemonPlanta* venusaur = new PokemonPlanta("Venusaur", 1, 15.0, 100.0, 1.0, "Investida", "Raio Solar");

PokemonPlanta* oddish = new PokemonPlanta("Oddish", 1, 15.0, 100.0, 1.0, "acido", "Chicote de Vinha");

PokemonPlanta* gloom = new PokemonPlanta("Gloom", 1, 15.0, 100.0, 1.0, "acido", "Po Adormecedor");

PokemonPlanta* vileplume = new PokemonPlanta("Vileplume", 1, 15.0, 100.0, 1.0, "acido", "Po Toxico");

PokemonPlanta* paras = new PokemonPlanta("Paras", 1, 15.0, 100.0, 1.0, "Arranhao", "Esporos");

PokemonPlanta* parasect = new PokemonPlanta("Parasect", 1, 15.0, 100.0, 1.0, "Arranhao", "Esporos");

// Normal

PokemonNormal* rattata = new PokemonNormal("Rattata", 1, 15.0, 100.0, 1.0, "Investida", "Mordida");

PokemonNormal* raticate = new PokemonNormal("Raticate", 1, 15.0, 100.0, 1.0, "Investida", "Hiper Presa");

PokemonNormal* meowth = new PokemonNormal("Meowth", 1, 15.0, 100.0, 1.0, "Arranhao", "Mordida");

PokemonNormal* persian = new PokemonNormal("Persian", 1, 15.0, 100.0, 1.0, "Investida", "Golpe Rapido");

PokemonNormal* farfetchd = new PokemonNormal("Farfetch'd", 1, 15.0, 100.0, 1.0, "Cortador de Vento", "Ataque de Espada");

PokemonNormal* doduo = new PokemonNormal("Doduo", 1, 15.0, 100.0, 1.0, "Investida", "Picada");

PokemonNormal* dodrio = new PokemonNormal("Dodrio", 1, 15.0, 100.0, 1.0, "Investida", "Tri Ataque");

PokemonNormal* lickitung = new PokemonNormal("Lickitung", 1, 15.0, 100.0, 1.0, "Lambida", "Ataque de Soco");

>>>>>>> 947656a8c3141346c023448604c10a436d417f53
...
std::vector<std::string> pokemonTypes = {
    "Grama", "Grama", "Grama/Venenoso", // Bulbasaur, Ivysaur, Venusaur
    "Fogo", "Fogo", "Fogo/Voador", // Charmander, Charmeleon, Charizard
    "Agua", "Agua", "Agua", // Squirtle, Wartortle, Blastoise
    "Inseto", "Inseto", "Inseto/Voador", // Caterpie, Metapod, Butterfree
    "Inseto/Venenoso", "Inseto/Venenoso", "Inseto/Venenoso", // Weedle, Kakuna, Beedrill
    "Normal/Voador", "Normal/Voador", "Normal/Voador", // Pidgey, Pidgeotto, Pidgeot
    "Normal", "Normal", "Normal/Voador", // Rattata, Raticate, Spearow
    "Normal/Voador", "Veneno", "Veneno", // Fearow, Ekans, Arbok
    "Eletrico", "Eletrico", "Eletrico", // Pikachu, Raichu
    "Terrestre", "Terrestre", "Terrestre", // Sandshrew, Sandslash
    "Veneno", "Veneno", "Veneno/Terra", // Nidoran♀, Nidorina, Nidoqueen
    "Veneno", "Veneno", "Veneno/Terra", // Nidoran♂, Nidorino, Nidoking
    "Fada", "Fada", "Fada", // Clefairy, Clefable
    "Fogo", "Fogo/Voador", // Vulpix, Ninetales
    "Normal/Fada", "Normal/Fada", // Jigglypuff, Wigglytuff
    "Venenoso/Voador", "Venenoso/Voador", // Zubat, Golbat
    "Grama/Venenoso", "Grama/Venenoso", "Grama/Venenoso", // Oddish, Gloom, Vileplume
    "Inseto/Venenoso", "Inseto/Venenoso", // Paras, Parasect
    "Inseto/Venenoso", "Inseto/Venenoso", // Venonat, Venomoth
    "Terrestre", "Terrestre", "Terrestre", // Diglett, Dugtrio
    "Normal", "Normal", // Meowth, Persian
    "Agua", "Agua", // Psyduck, Golduck
    "Lutador", "Lutador", // Mankey, Primeape
    "Fogo", "Fogo", // Growlithe, Arcanine
    "Agua", "Agua", "Agua", // Poliwag, Poliwhirl, Poliwrath
    "Psiquico", "Psiquico", "Psiquico", // Abra, Kadabra, Alakazam
    "Lutador", "Lutador", "Lutador", // Machop, Machoke, Machamp
    "Grama/Venenoso", "Grama/Venenoso", "Grama/Venenoso", // Bellsprout, Weepinbell, Victreebel
    "Agua/Venenoso", "Agua/Venenoso", // Tentacool, Tentacruel
    "Pedra/Terrestre", "Pedra/Terrestre", "Pedra/Terrestre", // Geodude, Graveler, Golem
    "Fogo", "Fogo", // Ponyta, Rapidash
    "Agua/Psiquico", "Agua/Psiquico", // Slowpoke, Slowbro
    "Eletrico/Metal", "Eletrico/Metal", // Magnemite, Magneton
    "Normal/Voador", "Normal/Voador", // Farfetch'd, Doduo, Dodrio
    "Agua/Voador", "Agua/Voador", // Seel, Dewgong
    "Venenoso", "Venenoso", "Venenoso", // Grimer, Muk
    "Agua/Gelo", "Agua/Gelo", "Agua/Gelo", // Shellder, Cloyster
    "Fantasma/Venenoso", "Fantasma/Venenoso", "Fantasma/Venenoso", // Gastly, Haunter, Gengar
    "Pedra/Terrestre", "Psiquico", // Onix, Drowzee, Hypno
    "Agua", "Agua", // Krabby, Kingler
    "Eletrico", "Eletrico", // Voltorb, Electrode
    "Grama/Psiquico", "Grama/Psiquico", "Grama/Psiquico", // Exeggcute, Exeggutor, Cubone
    "Grama/Psiquico", "Grama/Psiquico", "Grama/Psiquico", // Marowak, Hitmonlee, Hitmonchan
    "Normal", "Veneno", "Veneno", // Lickitung, Koffing, Weezing
    "Terrestre/Rocha", "Terrestre/Rocha", "Terrestre/Rocha", // Rhyhorn, Rhydon, Chansey
    "Grama", "Grama", "Grama", // Tangela, Kangaskhan, Horsea
    "Agua", "Agua", // Seadra, Goldeen, Seaking
    "Agua", "Agua", // Staryu, Starmie
    "Psiquico/Fada", "Inseto/Voador", "Eletrico", // Mr. Mime, Scyther, Jynx
    "Eletrico", "Fogo", "Fogo", // Electabuzz, Magmar, Pinsir
    "Normal", "Normal", "Agua/Voador", // Tauros, Magikarp, Gyarados
    "Agua/Gelo", "Agua/Gelo", "Agua/Gelo", // Lapras, Ditto, Eevee
    "Agua", "Agua", // Vaporeon, Jolteon
    "Fogo", "Normal", // Flareon, Porygon
    "Pedra/Agua", "Pedra/Agua", // Omanyte, Omastar
    "Pedra/Agua", "Pedra/Agua", // Kabuto, Kabutops
    "Pedra/Voador", "Normal", // Aerodactyl, Snorlax
    "Gelo/Voador", "Eletrico/Voador", "Fogo/Voador", // Articuno, Zapdos, Moltres
    "Dragão", "Dragão", "Dragão/Voador", // Dratini, Dragonair, Dragonite
    "Psiquico", "Psiquico" // Mewtwo, Mew
};
	...
	al_draw_scaled_bitmap(pokedex, 0, 0, al_get_bitmap_width(pokedex),
			...
			//Mudar essas funçoes
				...
				al_draw_textf(font80, al_map_rgb(0, 0, 0), 
							...
							"NOME:   %s", pokemonNames[x].c_str());
				al_draw_textf(font40, al_map_rgb(0, 0, 0), 
							1010, 410, ALLEGRO_ALIGN_CENTRE, 
							"HP: %.0f / Att: %.0f / Def: %.0f", p->getEnergia(), p->getDano(), p->getDanoSofrido());
				al_draw_textf(font40, al_map_rgb(0, 0, 0), 
							1010, 345, ALLEGRO_ALIGN_CENTRE, 
							"Pokemon %d", x);
				al_draw_textf(font64, al_map_rgb(0, 0, 0), 
<<<<<<< HEAD
							180, 565, ALLEGRO_ALIGN_LEFT, 
							"%s", p->getAtaqueBasico().c_str());
				al_draw_textf(font64, al_map_rgb(0, 0, 0), 
							550, 565, ALLEGRO_ALIGN_LEFT, 
							"%s", p->getAtaqueEletrico().c_str());
				al_draw_textf(font80, al_map_rgb(0, 0, 0), 
							1000, 550, ALLEGRO_ALIGN_CENTRE, 
							"Tipo: %s", p->getTipo().c_str());
=======
							180, 580, ALLEGRO_ALIGN_LEFT, 
							"%s", pikachu->getAtaqueBasico().c_str());
				al_draw_textf(font64, al_map_rgb(0, 0, 0), 
							530, 580, ALLEGRO_ALIGN_LEFT, 
							"%s", pikachu->getAtaqueEletrico().c_str());
				al_draw_textf(font64, al_map_rgb(0, 0, 0), 
							900, 530, ALLEGRO_ALIGN_CENTRE, 
							"Tipo: %s", pokemonTypes[x].c_str());
>>>>>>> 947656a8c3141346c023448604c10a436d417f53
		
			if(opcao == 1){
				al_draw_textf(font80, al_map_rgb(0, 0, 0), 
						130, 565, ALLEGRO_ALIGN_CENTRE, 
						"->");
			}
			if(opcao == 2){
				al_draw_textf(font80, al_map_rgb(0, 0, 0), 
						480, 565, ALLEGRO_ALIGN_CENTRE, 
						"->");
			}
}
...
void graficoBag (ALLEGRO_BITMAP *itens[], ALLEGRO_FONT *font80, ALLEGRO_FONT *font64){
	...
	if(opcao == 3){
		...
		al_draw_textf(font80, al_map_rgb(0, 0, 0), 
				210, 570, ALLEGRO_ALIGN_LEFT, 
				"Restaura a vida do Pokemon em 70.");
	}
	if(opcao == 4){
		al_draw_textf(font64, al_map_rgb(0, 0, 0), 
		...
		al_draw_textf(font80, al_map_rgb(0, 0, 0), 
				210, 570, ALLEGRO_ALIGN_LEFT, 
				"Restaura a vida do Pokemon em 100.");
	}
	if(opcao == 5){
		al_draw_textf(font64, al_map_rgb(0, 0, 0), 
...
=======
		/*if(opcao == 1){
			pikachu->setEnergia(_energia+20);
			usaItem = false;
		}
		if(opcao == 2){
			pikachu->setEnergia(_energia+50);
			usaItem = false;
		}
		if(opcao == 3){
			pikachu->setEnergia(_energia+70);
			usaItem = false;
		}
		if(opcao == 4){
			pikachu->setEnergia(_energia+100);
			usaItem = false;
		}
		if(opcao == 5){
			pikachu->setEnergia(_energia+200);
			usaItem = false;
		}
		if(opcao == 6){
			pikachu->setDanoRecebido(dano_sofrido+20);
			usaItem = false;
		}
		if(opcao == 7){
			pikachu->setDano(dano_ataque+20);
			usaItem = false;
		}
		if(opcao == 8){
			pikachu->setDanoRecebido(dano_sofrido+40);
			usaItem = false;
		}
		if(opcao == 9){
			pikachu->setDano(dano_ataque+40)
			usaItem = false;
		}
		if(opcao == 10){
			pikachu->setDano(dano_ataque+20);
...
void graficoBatalha (ALLEGRO_EVENT ev, ALLEGRO_BITMAP *fundobatalha, ALLEGRO_BITMAP *barraopcao, ALLEGRO_BITMAP *hp, ALLEGRO_BITMAP *hp2, ALLEGRO_BITMAP *sem, ALLEGRO_FONT *font, ALLEGRO_BITMAP *opcoes, ALLEGRO_BITMAP *treinadorcosta, ALLEGRO_BITMAP *pokebola, ALLEGRO_BITMAP *pokebolaa, ALLEGRO_BITMAP *pokemons[], ALLEGRO_BITMAP *pokemonsb[], ALLEGRO_BITMAP *animacaoataques[], ALLEGRO_BITMAP *barra, ALLEGRO_BITMAP *barraop, ALLEGRO_BITMAP *vs, ALLEGRO_BITMAP *barraeu, ALLEGRO_BITMAP *treinador, ALLEGRO_BITMAP *rivais[], ALLEGRO_FONT *font80, ALLEGRO_FONT *font64, ALLEGRO_SAMPLE_INSTANCE *instancemusicabatalha, ALLEGRO_SAMPLE *sompokemon[]){
	...
	if(tela2 > 420){
		...
		if(r->getEnergia() <= 0){
			...
			if(espera > 200){
				...
				menu = 1;
				opcao = 1;
				al_stop_sample_instance(instancemusicabatalha);
			}
			al_draw_scaled_bitmap(barraopcao, 0, 0, al_get_bitmap_width(barraopcao),
								al_get_bitmap_height(barraopcao),
								0, 504, SCREEN_W, 214, 0);
		...
		if(teste == false){
			...
			if(espera > 200){
				teste = true;	
				if(dano_recebido == true){
				std::string ataque = r->getAtaqueBasico();
				double dano = r->calcularDanoAtaque(ataque);
				p->receberDano(dano, r->getTipo());
				dano_recebido = false;
			}
			}
			/*if (dano_recebido == true){
		...
		double porcentagemvida = p->getEnergia();
		int barra;
		barra = 185 * porcentagemvida / 100;

		double porcentagemvida2 = r->getEnergia();
		int barra2;
		barra2 = 185 * porcentagemvida2 / 100;

		if(porcentagemvida2 > 50){
			al_draw_filled_rectangle(-273 + tela3, 157, -273 + tela3 + barra2, 169, al_map_rgb(0, 255, 0));
			al_draw_filled_rectangle(-273 + tela3, 157, -273 + tela3 + barra2, 161, al_map_rgb(0, 150, 0));
		}

		if(porcentagemvida2 <= 50 && porcentagemvida2 > 20){
			al_draw_filled_rectangle(-273 + tela3, 157, -273 + tela3 + barra2, 169, al_map_rgb(255, 255, 0));
			al_draw_filled_rectangle(-273 + tela3, 157, -273 + tela3 + barra2, 161, al_map_rgb(204, 204, 0));
		}

		if(porcentagemvida2 <= 20){
			al_draw_filled_rectangle(-273 + tela3, 157, -273 + tela3 + barra2, 169, al_map_rgb(255, 0, 0));
			al_draw_filled_rectangle(-273 + tela3, 157, -273 + tela3 + barra2, 161, al_map_rgb(100, 0, 0));
		}
	...
	if(opcao == 1 && escolhido == true){
		...
		al_draw_scaled_bitmap(opcoes, 0, 0, al_get_bitmap_width(opcoes),
					...
					780, 504, 500, 214, 0);
		al_draw_textf(font64, al_map_rgb(0, 0, 0), 
					110, 575, ALLEGRO_ALIGN_LEFT, 
					"%s", p->getAtaqueBasico().c_str());
		al_draw_textf(font64, al_map_rgb(0, 0, 0), 
					550, 575, ALLEGRO_ALIGN_LEFT, 
					"%s", p->getAtaqueEletrico().c_str());
		if(opcaoataque == 1){
			al_draw_textf(font64, al_map_rgb(0, 0, 0), 
					70, 580, ALLEGRO_ALIGN_CENTRE, 
					"->");
		}
		if(opcaoataque == 2){
			al_draw_textf(font64, al_map_rgb(0, 0, 0), 
					510, 580, ALLEGRO_ALIGN_CENTRE, 
					"->");
		}
		al_draw_textf(font80, al_map_rgb(0, 0, 0), 
		...
		al_draw_textf(font80, al_map_rgb(0, 0, 0), 
					...
					"Dano: 90");
		if(dano_ataque == true){
			std::string ataque = p->getAtaqueBasico();
			double dano = p->calcularDanoAtaque(ataque);
			r->receberDano(dano, p->getTipo());
			dano_ataque = false;
		}
...
void teclasBatalha (ALLEGRO_EVENT ev, ALLEGRO_SAMPLE *escolha, ALLEGRO_SAMPLE *somataques[]){
	...
	if(ev.keyboard.keycode == ALLEGRO_KEY_ENTER){
		...
		if (escolhido == true && opcaoataque == 1 && teste == true){
			dano_ataque = true;
			dano_recebido = true;
			selecionado = true;
			espera = 0;
		...
		if (escolhido == true && opcaoataque == 2 && teste == true){
			selecionado = true;
			dano_ataque = true;
			dano_recebido = true;
			espera = 0;
...
int main(int argc, char **argv){
	...
	equipe.adicionar_pokemon(pikachu);
	equipe.adicionar_pokemon(raichu);
	// inicializações padrao
	...
	// inicializaçao de arrays de imagens
	...
	// carrega o arquivo fonte padrao do pokemon e inicializa com difentes tipos de tamanho
...
<<<<<<< HEAD
	escolha = al_load_sample("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/KIT_DEV_ALLEGRO/Sons/escolha.ogg");
	comecajogo = al_load_sample("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Sons/comecajogo.ogg");

	// musica geral
	musicamenu = al_load_sample("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Sons/musicamenu.ogg");
=======
...
<<<<<<< HEAD
	musicabatalha = al_load_sample("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Sons/musicabatalha.ogg");
=======
...
>>>>>>> 947656a8c3141346c023448604c10a436d417f53
	...
	for (i = 1; i <= 151; ++i) {
        char caminho[200];
<<<<<<< HEAD
        sprintf(caminho, "C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Sons/Pokemon/%d.ogg", i);
=======
...
>>>>>>> 947656a8c3141346c023448604c10a436d417f53
	...
	for (i = 1; i <= 17; ++i) {
        char caminho[200];
<<<<<<< HEAD
        sprintf(caminho, "C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Sons/Ataques/%d.ogg", i);
=======
...
<<<<<<< HEAD
	fundomenu = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/menu.png");
	pokedex = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/pokedexfundo.png");
	caixa = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/menu2.png");
	barra = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha/telapreta.png");
	barraeu = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha/barraeu.png");
	barraop = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha/barraop.png");
	barraopcao = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha2/barraopcao.png");
	vs = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha/vs.png");
	fundobatalha = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha/fundobatalha.png");
	treinador = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha/eu.png");
	treinadorcosta = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha2/eu.png");
	pokebola = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha2/pokebola.png");
	pokebolaa = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha2/pokebolaa.png");
	hp = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha2/hp.png");
	hp2 = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha2/hp2.png");
	vivo = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha2/vivo.png");
	desmaiado = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha2/desmaiado.png");
	sem = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha2/sem.png");
	opcoes = al_load_bitmap("C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha2/opcoes.png");
=======
...
>>>>>>> 947656a8c3141346c023448604c10a436d417f53
	...
	for (i = 1; i <= 18; ++i) {
        char caminho[100];
<<<<<<< HEAD
        sprintf(caminho, "C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Ataques/%d.png", i);
=======
...
>>>>>>> 947656a8c3141346c023448604c10a436d417f53
	...
	for (i = 1; i <= 151; ++i) {
        char caminho[200];
<<<<<<< HEAD
        sprintf(caminho, "C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/firered-leafgreen/%d.png", i);
=======
...
>>>>>>> 947656a8c3141346c023448604c10a436d417f53
	...
	for (i = 1; i <= 151; ++i) {
        char caminho[200];
<<<<<<< HEAD
        sprintf(caminho, "C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/firered-leafgreen/back/%d.png", i);
=======
...
>>>>>>> 947656a8c3141346c023448604c10a436d417f53
	...
	for (i = 1; i <= 151; ++i) {
        char caminho[200];
<<<<<<< HEAD
        sprintf(caminho, "C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/pokemon/icons/%d.png", i);
=======
...
>>>>>>> 947656a8c3141346c023448604c10a436d417f53
	...
	for (i = 1; i <= 17; ++i) {
        char caminho[100];
<<<<<<< HEAD
        sprintf(caminho, "C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Tipos/%d.png", i);
=======
...
>>>>>>> 947656a8c3141346c023448604c10a436d417f53
	...
	for (i = 1; i <= 6; ++i) {
        char caminho[100];
<<<<<<< HEAD
        sprintf(caminho, "C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Efeitos/%d.png", i);
=======
...
>>>>>>> 947656a8c3141346c023448604c10a436d417f53
	...
	for (i = 1; i <= 5; ++i) {
        char caminho[100];
<<<<<<< HEAD
        sprintf(caminho, "C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Mapas/%d.png", i);
=======
...
>>>>>>> 947656a8c3141346c023448604c10a436d417f53
	...
	for (i = 1; i <= 5; ++i) {
        char caminho[100];
<<<<<<< HEAD
        sprintf(caminho, "C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Cards/%d.png", i);
=======
...
>>>>>>> 947656a8c3141346c023448604c10a436d417f53
	...
	for (i = 1; i <= 10; ++i) {
        char caminho[100];
<<<<<<< HEAD
        sprintf(caminho, "C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Mochila/%d.png", i);
=======
...
>>>>>>> 947656a8c3141346c023448604c10a436d417f53
	...
	for (i = 1; i <= 6; ++i) {
        char caminho[100];
<<<<<<< HEAD
        sprintf(caminho, "C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Equipe/%d.png", i);
=======
...
>>>>>>> 947656a8c3141346c023448604c10a436d417f53
	...
	for (i = 1; i <= 7; ++i) {
        char caminho[100];
<<<<<<< HEAD
        sprintf(caminho, "C:/TP-PDS2/2023-2-TN-grupo03/KIT_DEV_ALLEGRO/Imagens/Backgrounds/Batalha/%d.png", i);
=======
